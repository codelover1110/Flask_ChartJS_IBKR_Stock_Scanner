$(document).ready(function () {
  ...
  var priceChart_1 = new Chart(document.getElementById("priceChart-1").getContext("2d"), {
    type: "line",
    data: {
  ...
  var priceChart_2 = new Chart(document.getElementById("priceChart-2").getContext("2d"), {
    type: "line",
    data: {
      datasets: [{ label: "TSLA Price" }],
    },
  ...
  const vwapChart = new Chart(document.getElementById("volumeChart").getContext("2d"), {
    type: "line",
    data: {
      datasets: [{ label: "VWAP" }],
    },
    ...
    $.post(
      ...
      function (err, req, resp) {
        if (resp["responseJSON"]["value"]) {
          removeAlltData(priceChart_1, selectedValue);
          removeAlltData(priceChart_2, selectedValue);
  ...
  socket.on("updatePriceData", function (msg) {
    if (priceChart_1.data.labels.length > 20) {
      removeFirstData(priceChart_1);
      removeFirstData(priceChart_2);
    }
    addData(priceChart_1, msg.date, msg.value);
    addData(priceChart_2, msg.date, msg.value);
  });
